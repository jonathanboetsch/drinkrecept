...
function App() {
  const recipes = [
    ...
    },
    {
      ...
      imageUrl:
        "https://external-content.duckduckgo.com/iu/?u=https%3A%2F%2Fyummy-marie.com%2Fwp-content%2Fuploads%2F2024%2F08%2Fpina-colada.jpeg",
      timeInMins: 5,
      price: 120,
      categories: ["Cocktail", "Dryck"],
      instructions: ["Blanda och dryck!"],
      ingredients: [
        {
          name: "kokosmjölk",
          amount: 1,
