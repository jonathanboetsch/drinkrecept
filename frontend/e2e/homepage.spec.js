...
test.describe('Receptsajten - Homepage', () => {
  test('Happy path: startsidan visar receptkort och kategorier', async ({ page }) => {
    ...
    await expect(recipeCards).toHaveCount({ timeout: 10000 }, { gte: 1 });
  ...
  test('Sökflöde: sökning minskar lista, rensa visar alla igen, query i URL funkar på reload', async ({ page }) => {
    await page.goto('/');
